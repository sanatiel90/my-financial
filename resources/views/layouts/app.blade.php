...
<head>
    ...
    <title>{{ config('app.name', 'MyFinancial') }}</title>
...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light navbar-laravel" style="background-color: #C5E1A5;">
            <div class="container">
                <a class="navbar-brand" href="{{ route('home') }}">
                    {{ config('app.name', 'MyFinancial') }}
                </a>
